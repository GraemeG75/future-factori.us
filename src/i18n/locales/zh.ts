...
export const zh: Locale = {
  ...
  ui: {
    ...
    trade: {
      ...
      price: '价格',
      demand: '需求',
      noPartners: '尚未解锁任何贸易伙伴。',
      confirmSell: '以 ${2} 出售 {0} {1}？',
      confirmBuy: '以 ${2} 购买 {0} {1}？',
    },
    routes: {
      title: '路线',
      newRoute: '新路线',
    ...
    settings: {
      ...
      load: '加载游戏',
      newGame: '新游戏',
      confirmNewGame: '开始新游戏？未保存的进度将丢失。',
      apply: '应用',
      cancel: '取消',
    },
    hud: {
  ...
  messages: {
    buildingPlaced: '{0} 放置成功。',
    buildingDemolished: '{0} 已拆除。',
    buildingUpgraded: '{0} 升级至 {1} 级。',
    researchComplete: '研究完成：{0}',
    routeCreated: '已创建从 {0} 到 {1} 的路线。',
    routeDeleted: '路线已删除。',
    insufficientFunds: '资金不足。',
    insufficientResources: '资源不足。',
    insufficientPower: '能源不足。',
    storageFullFor: '{0} 存储已满。',
    unlocked: '{0} 已解锁！',
    tradeSuccess: '交易完成：{0} {1} 价值 ${2}。',
    tradeFailed: '交易失败：{0}。',
    gameSaved: '游戏已保存。',
    gameLoaded: '游戏已加载。',
    newGameStarted: '新游戏已开始。祝你好运，主任！',
    buildingRepaired: '{0} 已修复。',
    repairTooExpensive: '无法负担维修费用。',
    buildingBroken: '{0} 已损坏，需要维修！',
  },

  alerts: {
    research_complete: '研究完成：{0} — 已解锁 {1}',
    building_breakdown: '{0} 发生故障！修复它以恢复效率。',
    deposit_low: '矿床即将耗尽 — {1} 接近枯竭！',
    deposit_depleted: '矿床已耗尽 — {1} 已完全耗尽。',
    achievement_unlocked: '{1} 成就解锁：{0}',
    contract_new: '新合同：交付 {1}× {0} 获得 ${2}！',
    contract_completed: '合同完成！交付了 {0} — 获得 ${1}。',
    contract_failed: '合同失败！无法交付 {0} — 扣除 ${1} 罚款。',
    loan_taken: '已获得 ${0} 贷款。',
    loan_repaid: '${0} 贷款已全额还清！',
    loan_overdue: '贷款逾期！余额 ${0} — 立即还款以避免更多罚款。',
  },

  events: {
    trade_embargo: '⚠️ 贸易禁运！{0} 拒绝交易 — 价格大幅下跌。',
    resource_boom: '📈 资源繁荣！{0} 价格飙升。',
    market_crash: '📉 市场崩溃！所有价格急剧下跌。',
    subsidy: '💰 政府补贴！{0} 价格上涨。',
    tech_demand_surge: '🔬 技术需求激增！{0} 价格短暂翻倍。',
    pollution_fine: '🌫️ 污染罚款！因环境违规价格受到抑制。',
  },

  achievements: {
    first_building: {
      name: '初次尝试',
      description: '放置你的第一栋建筑。',
    },
    power_up: {
      name: '启动电源',
      description: '建造一座发电厂。',
    ...
    first_research: {
      name: '知识探索者',
      description: '完成你的第一项研究。',
    },
    cash_1k: {
      name: '小额收益',
      description: '积累 $1,000。',
    },
    cash_10k: {
      name: '盈利企业',
      description: '积累 $10,000。',
    },
    cash_100k: {
      name: '大亨',
      description: '积累 $100,000。',
    },
    five_routes: {
      name: '物流网络',
      description: '创建5条运输路线。',
    },
    repair_crew: {
      name: '维修队',
      description: '修复一栋损坏的建筑。',
    },
    polluter: {
      name: '污染问题',
      description: '让污染达到50级。',
    },
    clean_factory: {
      name: '清洁工业',
      description: '在拥有5栋以上建筑的情况下保持低污染。',
    },
    deposit_depleted: {
      name: '耗尽的矿床',
      description: '完全耗尽一个资源矿床。',
    },
    first_contract: {
      name: '谈判高手',
      description: '完成你的第一份配送合同。',
    },
    ten_contracts: {
      name: '合同之王',
      description: '完成10份配送合同。',
    },
    first_loan: {
      name: '借贷者',
      description: '取得你的第一笔贷款。',
    },
    debt_free: {
      name: '无债一身轻',
      description: '偿还所有未偿贷款。',
    },
    market_event: {
      name: '市场观察者',
      description: '目睹一次市场事件。',
    },
    tier5_research: {
      name: '奇点后时代',
      description: '完成一项第五阶层奇点后研究。',
    },
    synergy_active: {
      name: '协同效应！',
      description: '解锁跨技术生产协同加成。',
    },
    prototype_built: {
      name: '原型工程师',
      description: '建造一座原型级建筑。',
    },
  },
  ...
  controls: {
    ...
    keys: {
      leftClick: '左键单击',
      rightClickDrag: '右键 + 拖动',
      middleClickDrag: '中键 + 拖动',
      scrollWheel: '滚轮',
      escape: 'Escape',
      b: 'B',
      r: 'R',
  ...
  scenarios: {
    tutorial: {
      name: '教程',
      description: '学习 Future Factorius 的基础知识。建造你的第一座工厂，赚取 $5,000，并完成你的第一项研究。',
      obj_place_factory: '放置3栋建筑',
      obj_earn_cash: '积累 $5,000',
      obj_first_research: '完成1项研究',
    },
    fast_start: {
      name: '快速开始',
      description: '与时间赛跑！在时间限制内赚取 $50,000 并运营10栋建筑。',
      obj_earn_50k: '赚取 $50,000',
      obj_ten_buildings: '运营10栋建筑',
    },
    survival: {
      name: '生存模式',
      description: '从几乎一无所有开始。在时间限制内生存并完成5份合同。',
      obj_survive: '保持资金在 $0 以上',
      obj_contracts: '完成5份合同',
    },
    sandbox: {
      name: '沙盒模式',
      description: '无限资源和起始资金。自由建造，没有任何限制。',
    },
    ui: {
      title: '场景',
      selectMode: '选择游戏模式',

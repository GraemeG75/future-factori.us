...
export class Vector3 {
  ...
  distanceTo(v: Vector3) { return new Vector3(this.x - v.x, this.y - v.y, this.z - v.z).length(); }
...
export class Object3D {
  ...
  remove(obj: Object3D) { this.children = this.children.filter(c => c !== obj); return this; }
  traverse(fn: (o: Object3D) => void) { fn(this); this.children.forEach(c => c.traverse(fn)); }
  lookAt() {}
  updateMatrix() {}
  updateMatrixWorld() {}
  getWorldPosition(target: Vector3) { target.copy(this.position); return target; }
}
...
export class CylinderGeometry extends BufferGeometry {
  constructor(_rt?: number, _rb?: number, _h?: number, _seg?: number) { super(); }
}
...
export class TorusGeometry extends BufferGeometry {
  constructor(_r?: number, _t?: number, _rs?: number, _ts?: number) { super(); }
}

export class SphereGeometry extends BufferGeometry {
  constructor(_r?: number, _ws?: number, _hs?: number) { super(); }
}
...
export class MeshStandardMaterial extends Material {
  ...
  metalness = 0;
  roughness = 1;
  constructor(params?: Record<string, unknown>) { super(); Object.assign(this, params); }
}
...
export class Raycaster {
  ...
  setFromCamera() {}
  intersectObjects(_objects: unknown[], _recursive?: boolean) { return []; }
}
